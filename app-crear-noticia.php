        ...
        <div id="main">
            ...
            <div class="uk-container-center w-95 bg-white uk-padding-small">
                <div class="uk-width-9-10 uk-container-center uk-block">
                    <div class="bg-gray">
                        <h4 class="p-blocks">Agregar nueva categoría</h4>
                    </div>
                    <form class="uk-form uk-grid">
                        <div class="uk-width-1-2">
                            <div class="uk-width-1-1">
                                <label class="f-label-m" for="nomCategoria">Nombre de la categoría</label>
                                <input class="uk-margin-small-top uk-form-small uk-width-1-1 browser-default" type="text" placeholder="Estado de México" name="nomCategoria" id="inpNomCategoria">
                            </div>
                            <div class="uk-width-1-1 uk-margin-top">
                                <label class="f-label-m" for="linkDestino">Link de destino</label>
                                <input class="uk-margin-small-top uk-form-small uk-width-1-1 browser-default" type="text" placeholder="URL" name="linkDestino" id="inpLinkDestino">
                            </div>
                            <div class="uk-width-1-1 uk-margin-top">
                    ...
                    <div class="uk-block uk-width-1-1 uk-padding-bottom-remove">
                        <a href="app-noticias.php" id="saveProgram" class="uk-button uk-contrast uk-width-1-5 uk-margin-right btn-purple">Guardar</a>
                        <a href="app-noticias.php" id="cancelarProgram" class="uk-button uk-width-1-5 btn-forms-t">Cancelar</a>
                    </div>
                </div>
            </div>
        </div>

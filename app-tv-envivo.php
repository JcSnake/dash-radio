...
<html class="loading" lang="es" data-textdirection="ltr">
  ...
  <!-- END: Head-->
    <body class="vertical-layout page-header-light vertical-menu-collapsible vertical-menu-nav-dark 2-columns  " data-open="click" data-menu="vertical-menu-nav-dark" data-col="2-columns">
        ...
        <?php include_once('template/nav-bar/nav-app-tv-envivo.php') ?>
        <div id="main">
            ...
            <div class="uk-container-center w-95 bg-white uk-padding-small">
                <div class="uk-width-9-10 uk-container-center uk-block">
                    ...
                    <form class="uk-form uk-grid uk-margin-top" name="formTvLive">
                        <div class="uk-width-1-2">
                            <div class="uk-width-1-1">
                                <label for="linkStreaming" class="f-label-m">Link de destino</label>
                                <input class="uk-margin-top uk-form-small uk-width-1-1 browser-default" type="text" placeholder="URL" name="linkStreaming" id="inpLinkStreaming" value="Https:// streaming.com/tv2312312312312">
                            </div>
                            <div class="uk-width-1-1 uk-margin-top">
                                <label for="titleSection" class="f-label-m">Título de la sección</label>
                                <input class="uk-margin-top uk-form-small uk-width-1-1 browser-default" type="text" placeholder="Título de la sección" name="titleSection" id="titleSection" value="">
                            </div>
                            <div class="uk-width-1-2 uk-margin-top">
                                <label for="imgSquare" class="f-label-m">Agregar foto Home</label>
                    ...
                    <div class="uk-block uk-width-1-1 uk-padding-bottom-remove">
                        <button id="saveTvApp" class="uk-button uk-contrast uk-width-1-5 uk-margin-right btn-purple">Guardar</button>
                    </div>
                </div>
            </div>
        </div>

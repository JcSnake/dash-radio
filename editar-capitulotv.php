    ...
    <body class="vertical-layout page-header-light vertical-menu-collapsible vertical-menu-nav-dark 2-columns  " data-open="click" data-menu="vertical-menu-nav-dark" data-col="2-columns">
        ...
        <div id="main">
            <ul class="uk-breadcrumb w-95 uk-container-center uk-margin-top">
                ...
                <li class="uk-active"><span class="uk-h2">Editar capítulo</li>
            </ul>
                    ...
                    <form class="uk-form uk-grid">
                        <div class="uk-width-1-2">
                            <div class="uk-width-1-1">
                                <label class="f-label-m" for="nomCapitulo">Nombre del capítulo</label>
                            ...
                            <div class="uk-width-1-1 uk-margin-top">
                                <label class="f-label-m" for="urlCap">Agregar URL</label>
                            ...
                            <div class="uk-width-1-1 uk-margin-top">
                                <label class="f-label-m" for="programCap">Agregar a programa</label>
                            ...
                            <div class="uk-width-1-1 uk-margin-top">
                                <label class="f-label-m" for="tempCap">Agregar a temporada</label>
                        ...
                        <div class="uk-width-1-2">
                            <div class="uk-width-1-1">
                                <label class="f-label-m" for="descriptionCap">Agregar descripción</label>
                            ...
                            <div class="uk-width-1-1 uk-margin-top">
                                <label class="f-label-m" for="descriptionCap">Agregar imagen de portada</label>

    ...
    <body class="vertical-layout page-header-light vertical-menu-collapsible vertical-menu-nav-dark 2-columns  " data-open="click" data-menu="vertical-menu-nav-dark" data-col="2-columns" style="height: 140% !important;">
        ...
        <div id="main">
            <ul class="uk-breadcrumb w-95 uk-container-center uk-margin-top">
                ...
                <li class="uk-active"><span class="uk-h2">Editar categoría</li>
            </ul>
                ...
                <div class="uk-width-9-10 uk-container-center uk-block">
                    ...
                    <form class="uk-form uk-grid">
                        <div class="uk-width-1-2">
                            ...
                            <input class="uk-margin-top uk-form-small uk-width-1-1 browser-default" type="text" placeholder="Nombre" name="nomCategoria" id="nomCategoria">
                        </div>
                        <div class="uk-width-1-2">
                            &nbsp;
                        </div>
                        <div class="uk-width-1-2 uk-margin-top">
                            ...
                            <textarea class="uk-margin-top uk-width-1-1 uk-form-small browser-default" name="descriptionCat" id="descriptionCat" cols="40" rows="5" placeholder="Escribe aquí"></textarea>
                        </div>
                        <div class="uk-width-1-2 uk-margin-top">
                            &nbsp;
                        </div>

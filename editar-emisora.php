        ...
        <div id="main">
            ...
            <div class="uk-container-center w-95 bg-white uk-padding-small">
                <div class="uk-width-9-10 uk-container-center uk-block">
                    <div class="bg-gray">
                        <h4 class="p-blocks">Editar estación</h4>
                    </div>
                    <form class="uk-form uk-grid">
                        <div class="uk-width-1-2">
                            <div class="uk-width-1-1">
                                <label class="f-label-m" for="NomEstacion">Nombre de la estación</label>
                                <input class="uk-margin-small-top uk-form-small uk-width-1-1 browser-default" type="text" placeholder="Nombre de la estación" name="NomEstacion" id="inpNomEstacion" value="Metepec 91.7 AM">
                            </div>
                            <div class="uk-width-1-1 uk-margin-top">
                                <label class="f-label-m" for="linkStreaming">Link del streaming</label>
                                <input class="uk-margin-small-top uk-form-small uk-width-1-1 browser-default" type="text" placeholder="URL" name="linkStreaming" id="inpLinkStreaming" value="Https:// streaming.com/radio12312312312312">
                            </div>
                            <div class="uk-width-1-1 uk-margin-top">
                                <label class="f-label-m" for="description">Agregar descripción</label>
                                <textarea name="description" id="txtDescription" cols="30" rows="3" placeholder="Escribe aquí" value="Programa"></textarea>
                            </div>
                            <div class="uk-width-1-1 uk-margin-top">
                                <label class="f-label-m" for="imgSquare">Agregar foto para la pantalla</label>

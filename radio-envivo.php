                        ...
                        <ul id="tabs-radio" class="uk-switcher uk-margin uk-form">
                            <li class="w-95 uk-container-center">
                                <div class="uk-width-1-2">
                                    <label for="title" class="f-label-m">Título</label>
                                    <input class="uk-margin-small-top uk-form-small uk-width-1-1 browser-default" type="text" placeholder="Radio en vivo" name="title" id="inpTitle">
                                </div>
                            ...
                            <li>
                                <div class="uk-flex uk-flex-right p-table uk-padding-bottom-remove uk-padding-top-remove">
                                    <form class="uk-form uk-width-2-3 uk-margin-top uk-grid uk-grid-small uk-flex uk-flex-right">
                                        ...
                                        <div class="w5">
                                            <a href="crear-emisora.php" class="uk-button uk-width-1-1 uk-button-small btn-search">
                                        ...
                                        <tbody>
                                            <tr class="uk-table-divider">
                                                ...
                                                <td class="uk-text-center">
                                                    <a href="editar-emisora.php" class="uk-button btn-search"><i class="c-icons uk-icon-pencil"></i></a>

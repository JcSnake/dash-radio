            ...
            <div class="uk-container-center w-95 bg-white uk-padding-small">
                <div class="uk-flex uk-flex-right p-table uk-padding-bottom-remove uk-padding-top-remove">
                    <form class="uk-form uk-width-3-4 uk-margin-top uk-grid uk-grid-small uk-flex uk-flex-right">
                        ...
                        <div class="w5">
                            <a href="crear-categoriatv.php" class="uk-button uk-width-1-1 uk-button-small btn-search">
                    ...
                    <table class="uk-table" id="userTable">
                        <thead>
                            <tr>
                                ...
                                <th class="uk-text-center c-black uk-text-capitalize font-bold">No. Programas</th>
                        ...
                        <tbody>
                            <tr class="uk-table-divider">
                                ...
                                <td class="uk-text-center">
                                    <a href="editar-categoriatv.php" class="uk-button btn-search"><i class="c-icons uk-icon-pencil"></i></a>
            ...
            <div class="uk-modal-dialog border-radius-5 w-modal-cuenta">
                <div>
                    <div class="uk-text-center">
                        <h3 class="uk-width-9-10 uk-container-center uk-text-bold">¿Estás seguro que deseas borrar esta categoría?</h3>

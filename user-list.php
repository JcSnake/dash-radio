...
<html class="loading" lang="es" data-textdirection="ltr">
  ...
  <!-- END: Head-->
    <body class="vertical-layout page-header-light vertical-menu-collapsible vertical-menu-nav-dark 2-columns  " data-open="click" data-menu="vertical-menu-nav-dark" data-col="2-columns">
        ...
        <?php include_once('template/nav-bar/nav-user.php') ?>
        <div id="main">
            <h2 class="uk-margin-top w-95 uk-container-center c-gray">Usuarios (232,000)</h2>
            <div class="uk-container-center w-95 bg-white uk-padding-small">
                <div class="uk-flex uk-flex-right p-table uk-padding-bottom-remove uk-padding-top-remove">
                    <form class="uk-form uk-width-2-3 uk-margin-top uk-grid uk-grid-small">
                        <div class="uk-width-1-4">
                            <select class="uk-width-1-1 uk-form-small browser-default brd-form-style" name="edad" id="selectEdad">
                                <option value="0">Edad</option>
                            </select>
                        </div>
                        <div class="uk-width-1-4">
                            <select class="uk-width-1-1 uk-form-small browser-default brd-form-style" name="sexo" id="selectSexo">
                    ...
                    <table class="uk-table" id="userTable">
                        <thead>
                            <tr>
                                ...
                                <th class="uk-text-center c-black uk-text-capitalize font-bold">Edad</th>
                                <th class="uk-text-center c-black uk-text-capitalize font-bold">Sexo</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="uk-text-center">M</td>
                                <td class="uk-text-center">15/01/19</td>
                            </tr>
                            <tr>
                                <td class="uk-text-center">893864</td>
                                <td class="uk-text-center">Maya Martínez</td>
                                ...
                                <td class="uk-text-center">19</td>
                                <td class="uk-text-center">M</td>
                                <td class="uk-text-center">10/01/19</td>
                            </tr>
                            <tr>
                                <td class="uk-text-center">893864</td>
                                <td class="uk-text-center">Maya Martínez</td>
